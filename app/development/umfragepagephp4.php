...
<?php  }; ?>
  ...
  <main>
    <div class="main">
      ...
      <div class="vorher">
        <a href="umfragepagephp3.php" title="Vorherige Seite"><button type="button" name="umfrage">Vorherige Seite</button></a>
      </div>
      <div class="naechste">
        <a href="umfragepagephp5.php" title="Folgende Seite"><button type="button" name="umfrage">Nächste Seite</button></a>
      </div>
    </div>
  </main>
